...
from model.ResNet import BasicBlock, make_layer
...
class DLA(nn.Module):
    def __init__(self, num_class):
        ...
        self.block1a = FeatureExtractor(3, 64, 4, stride=1)
        self.block2a = FeatureExtractor(64, 64, 5, stride=2)
